...
class RequestManagerRetriever implements Handler.Callback {
    ...
    private String mTag = Immersion.class.getName();
    ...
    public Immersion get(Activity activity) {
    ...
    public Immersion get(Fragment fragment, boolean isOnly) {
    ...
    public Immersion get(android.app.Fragment fragment, boolean isOnly) {
        checkNotNull(fragment, "fragment is null");
        checkNotNull(fragment.getActivity(), "fragment.getActivity() is null");
    ...
    public Immersion get(Activity activity, Dialog dialog) {
        checkNotNull(activity, "activity is null");
